...
class TestDataCSVValidationDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DataCSVValidationDTO:
        """Test DataCSVValidationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataCSVValidationDTO`
        """
        model = DataCSVValidationDTO()
        if include_optional:
            return DataCSVValidationDTO(
                ...
                data_errors = openapi_client.models.data_csv_validation_model.DataCSVValidationModel(
                    missing_headers = [
                        ''
                        ], 
                    empty_headers = [
