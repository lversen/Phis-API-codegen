...
class TestScientificObjectUpdateDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScientificObjectUpdateDTO:
        """Test ScientificObjectUpdateDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScientificObjectUpdateDTO`
        """
        model = ScientificObjectUpdateDTO()
        if include_optional:
            return ScientificObjectUpdateDTO(
