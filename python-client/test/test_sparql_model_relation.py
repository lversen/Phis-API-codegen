...
class TestSPARQLModelRelation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SPARQLModelRelation:
        """Test SPARQLModelRelation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SPARQLModelRelation`
        """
        model = SPARQLModelRelation()
        if include_optional:
            return SPARQLModelRelation(
                graph = '',
