...
class TestVariableCreationDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VariableCreationDTO:
        """Test VariableCreationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariableCreationDTO`
        """
        model = VariableCreationDTO()
        if include_optional:
            return VariableCreationDTO(
