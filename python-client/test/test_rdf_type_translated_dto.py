...
class TestRDFTypeTranslatedDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RDFTypeTranslatedDTO:
        """Test RDFTypeTranslatedDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RDFTypeTranslatedDTO`
        """
        model = RDFTypeTranslatedDTO()
        if include_optional:
            return RDFTypeTranslatedDTO(
                uri = '',
                name = '',
                comment = '',
                parent = '',
