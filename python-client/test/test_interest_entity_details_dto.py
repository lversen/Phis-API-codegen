...
class TestInterestEntityDetailsDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InterestEntityDetailsDTO:
        """Test InterestEntityDetailsDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterestEntityDetailsDTO`
        """
        model = InterestEntityDetailsDTO()
        if include_optional:
