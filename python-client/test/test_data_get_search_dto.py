...
class TestDataGetSearchDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DataGetSearchDTO:
        """Test DataGetSearchDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataGetSearchDTO`
        """
        model = DataGetSearchDTO()
        if include_optional:
            return DataGetSearchDTO(
