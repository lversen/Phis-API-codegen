...
class TestGermplasmGroupUpdateDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GermplasmGroupUpdateDTO:
        """Test GermplasmGroupUpdateDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GermplasmGroupUpdateDTO`
        """
        model = GermplasmGroupUpdateDTO()
        if include_optional:
            return GermplasmGroupUpdateDTO(
                uri = '',
