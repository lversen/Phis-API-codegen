...
class TestFactorDetailsGetDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FactorDetailsGetDTO:
        """Test FactorDetailsGetDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FactorDetailsGetDTO`
        """
        model = FactorDetailsGetDTO()
        if include_optional:
            return FactorDetailsGetDTO(
                ...
                levels = [
                    openapi_client.models.factor_level_get_dto.FactorLevelGetDTO(
