...
class TestBrAPIv1SingleObservationVariableResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BrAPIv1SingleObservationVariableResponse:
        """Test BrAPIv1SingleObservationVariableResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrAPIv1SingleObservationVariableResponse`
        """
        model = BrAPIv1SingleObservationVariableResponse()
        if include_optional:
            return BrAPIv1SingleObservationVariableResponse(
                ...
                result = openapi_client.models.br_apiv1_observation_variable_dto.BrAPIv1ObservationVariableDTO(
                    context_of_use = [
                        ''
                        ], 
                    crop = '', 
