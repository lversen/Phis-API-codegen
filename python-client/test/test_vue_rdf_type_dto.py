...
class TestVueRDFTypeDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VueRDFTypeDTO:
        """Test VueRDFTypeDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VueRDFTypeDTO`
        """
        model = VueRDFTypeDTO()
        if include_optional:
            return VueRDFTypeDTO(
                ...
                is_abstract = True,
                data_properties = [
                    openapi_client.models.vue_rdf_type_property_dto.VueRDFTypePropertyDTO(
                        uri = '', 
                        name = '', 
                        comment = '', 
                        inherited = True, 
