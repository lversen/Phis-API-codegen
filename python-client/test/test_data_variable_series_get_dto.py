...
class TestDataVariableSeriesGetDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DataVariableSeriesGetDTO:
        """Test DataVariableSeriesGetDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataVariableSeriesGetDTO`
        """
        model = DataVariableSeriesGetDTO()
        if include_optional:
            return DataVariableSeriesGetDTO(
                variable = openapi_client.models.variable_details_dto.VariableDetailsDTO(
                    ...
                    from_shared_resource_instance = openapi_client.models.shared_resource_instance_dto.SharedResourceInstanceDTO(
                        ...
                        label = '', ), ),
                provenances = [
                    openapi_client.models.data_simple_provenance_get_dto.DataSimpleProvenanceGetDTO(
                        uri = '', 
                        rdf_type = '', 
                        name = '', )
                    ],
                devices = [
                    openapi_client.models.device_get_dto.DeviceGetDTO(
                        uri = '', 
                ...
                data_series = [
                    openapi_client.models.data_serie_get_dto.DataSerieGetDTO(
                ...
                last_data_stored = openapi_client.models.data_computed_get_dto.DataComputedGetDTO(
                    date = '2020-08-21T00:00+01:00', 
                    value = 8.6, )
            )
        else:
