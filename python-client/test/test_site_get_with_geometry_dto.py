...
class TestSiteGetWithGeometryDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SiteGetWithGeometryDTO:
        """Test SiteGetWithGeometryDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SiteGetWithGeometryDTO`
        """
        model = SiteGetWithGeometryDTO()
        if include_optional:
            return SiteGetWithGeometryDTO(
                uri = '',
                rdf_type = '',
                rdf_type_name = '',
