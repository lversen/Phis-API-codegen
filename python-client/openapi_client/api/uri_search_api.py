...
class UriSearchApi:
    ...
    def search_by_uri(
        self,
        uri: Annotated[StrictStr, Field(description="URI")],
        ...
        _param = self._search_by_uri_serialize(
            uri=uri,
    ...
    @validate_call
    def search_by_uri_with_http_info(
        self,
        uri: Annotated[StrictStr, Field(description="URI")],
        authorization: Annotated[StrictStr, Field(description="Authentication token")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Request accepted language")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[URIGlobalSearchDTO]:
        """Get a list of objects that match the passed URI
    ...
    @validate_call
    def search_by_uri_without_preload_content(
        self,
        uri: Annotated[StrictStr, Field(description="URI")],
        authorization: Annotated[StrictStr, Field(description="Authentication token")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Request accepted language")] = None,
    ...
    def _search_by_uri_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/uri_search/{uri}',
