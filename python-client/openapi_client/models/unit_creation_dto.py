...
class UnitCreationDTO(BaseModel):
    """
    UnitCreationDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["uri", "name", "description", "symbol", "alternative_symbol", "exact_match", "close_match", "broad_match", "narrow_match"]
