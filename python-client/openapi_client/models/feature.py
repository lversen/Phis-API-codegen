...
class Feature(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "bbox", "coordinates", "properties", "geometry", "id"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Feature', 'Polygon', 'MultiPolygon', 'FeatureCollection', 'Point', 'MultiPoint', 'MultiLineString', 'LineString', 'GeometryCollection']):
            raise ValueError("must be one of enum values ('Feature', 'Polygon', 'MultiPolygon', 'FeatureCollection', 'Point', 'MultiPoint', 'MultiLineString', 'LineString', 'GeometryCollection')")
        return value
