...
class Faidarev1ContactDTO(BaseModel):
    """
    Faidarev1ContactDTO
    """ # noqa: E501
    contact_db_id: Optional[StrictStr] = Field(default=None, alias="contactDbId")
    email: Optional[StrictStr] = None
    institution_name: Optional[StrictStr] = Field(default=None, alias="institutionName")
    name: Optional[StrictStr] = None
    orcid: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["contactDbId", "email", "institutionName", "name", "orcid", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contactDbId": obj.get("contactDbId"),
            "email": obj.get("email"),
