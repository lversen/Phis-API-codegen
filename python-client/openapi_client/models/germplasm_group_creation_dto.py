...
class GermplasmGroupCreationDTO(BaseModel):
    """
    ...
    germplasm_list: Optional[List[StrictStr]] = None
    publisher: Optional[UserGetDTO] = None
    publication_date: Optional[datetime] = None
    last_updated_date: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["uri", "name", "description", "germplasm_list", "publisher", "publication_date", "last_updated_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "germplasm_list": obj.get("germplasm_list"),
