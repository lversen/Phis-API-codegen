...
class FactorCreationDTO(BaseModel):
    """
    FactorCreationDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["uri", "name", "category", "description", "levels", "exact_match", "close_match", "broad_match", "narrow_match", "experiment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "levels": [FactorLevelCreationDTO.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None,
