...
class OrganizationDagDTO(BaseModel):
    """
    OrganizationDagDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["uri", "name", "parents", "children", "facilities", "rdf_type", "rdf_type_name", "publication_date", "last_updated_date"]
