...
class UserGetDTO(BaseModel):
    ...
    UserGetDTO
    """ # noqa: E501
    uri: Optional[StrictStr] = Field(default=None, description="User URI")
    email: Optional[StrictStr] = Field(default=None, description="User email")
    language: Optional[StrictStr] = Field(default=None, description="User language")
    admin: Optional[StrictBool] = Field(default=None, description="User admin flag")
    ...
    __properties: ClassVar[List[str]] = ["uri", "email", "language", "admin", "first_name", "last_name", "linked_person", "enable", "favorites"]
