...
class DataGetDetailsDTO(BaseModel):
    """
    DataGetDetailsDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["uri", "date", "target", "variable", "value", "confidence", "provenance", "metadata", "publisher", "raw_data", "issued", "modified"]
