...
class OrganizationCreationDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uri", "rdf_type", "rdf_type_name", "name", "parents", "groups", "facilities", "publication_date", "last_updated_date"]
