...
class BrapiDataResponsePartListFaidarev1TrialDTO(BaseModel):
    """
    BrapiDataResponsePartListFaidarev1TrialDTO
    """ # noqa: E501
    data: Optional[List[Faidarev1TrialDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Faidarev1TrialDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
