...
class SiteGetListDTO(BaseModel):
    """
    SiteGetListDTO
    """ # noqa: E501
    ...
    facilities: Optional[List[NamedResourceDTO]] = None
    rdf_type: Optional[StrictStr] = None
    rdf_type_name: Optional[StrictStr] = None
    publication_date: Optional[datetime] = None
    last_updated_date: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["uri", "name", "address", "description", "organizations", "facilities", "rdf_type", "rdf_type_name", "publication_date", "last_updated_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "facilities": [NamedResourceDTO.from_dict(_item) for _item in obj["facilities"]] if obj.get("facilities") is not None else None,
