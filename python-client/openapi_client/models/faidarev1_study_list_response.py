...
class Faidarev1StudyListResponse(BaseModel):
    """
    Faidarev1StudyListResponse
    """ # noqa: E501
    metadata: Optional[MetadataDTO] = None
    result: Optional[BrapiDataResponsePartListFaidarev1StudyDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": BrapiDataResponsePartListFaidarev1StudyDTO.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
