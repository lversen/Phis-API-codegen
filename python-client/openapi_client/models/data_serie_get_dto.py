...
class DataSerieGetDTO(BaseModel):
    """
    DataSerieGetDTO
    """ # noqa: E501
    provenance: Optional[DataSimpleProvenanceGetDTO] = None
    data: Optional[List[DataComputedGetDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "provenance": DataSimpleProvenanceGetDTO.from_dict(obj["provenance"]) if obj.get("provenance") is not None else None,
            "data": [DataComputedGetDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
