...
class RDFTypeTranslatedDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uri", "name", "comment", "parent", "publisher", "publicationDate", "lastUpdatedDate", "name_translations", "comment_translations"]
