...
class SiteGetWithGeometryDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uri", "rdf_type", "rdf_type_name", "publisher", "publication_date", "last_updated_date", "name", "facilities", "geometry"]
