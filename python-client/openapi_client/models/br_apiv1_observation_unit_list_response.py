...
class BrAPIv1ObservationUnitListResponse(BaseModel):
    """
    BrAPIv1ObservationUnitListResponse
    """ # noqa: E501
    metadata: Optional[MetadataDTO] = None
    result: Optional[BrapiDataResponsePartListBrAPIv1ObservationUnitDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": BrapiDataResponsePartListBrAPIv1ObservationUnitDTO.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
