...
class SiteCreationDTO(BaseModel):
    """
    SiteCreationDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["uri", "rdf_type", "name", "address", "organizations", "facilities", "groups", "description", "rdf_type_name", "publication_date", "last_updated_date"]
