...
class DataUpdateDTO(BaseModel):
    """
    DataUpdateDTO
    """ # noqa: E501
    uri: StrictStr = Field(description="URI of the data being updated")
    ...
    __properties: ClassVar[List[str]] = ["uri", "date", "timezone", "target", "variable", "value", "confidence", "provenance", "metadata", "raw_data"]
