...
class BrAPIv1SingleStudyResponse(BaseModel):
    """
    BrAPIv1SingleStudyResponse
    """ # noqa: E501
    metadata: Optional[MetadataDTO] = None
    result: Optional[BrAPIv1SuperStudyDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": BrAPIv1SuperStudyDTO.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
