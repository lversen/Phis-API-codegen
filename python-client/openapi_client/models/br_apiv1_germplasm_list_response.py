...
class BrAPIv1GermplasmListResponse(BaseModel):
    """
    BrAPIv1GermplasmListResponse
    """ # noqa: E501
    metadata: Optional[MetadataDTO] = None
    result: Optional[BrapiDataResponsePartListBrAPIv1GermplasmDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": BrapiDataResponsePartListBrAPIv1GermplasmDTO.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
