...
class BrAPIv1ObservationVariableListResponse(BaseModel):
    """
    BrAPIv1ObservationVariableListResponse
    """ # noqa: E501
    metadata: Optional[MetadataDTO] = None
    result: Optional[BrapiDataResponsePartListBrAPIv1ObservationVariableDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": BrapiDataResponsePartListBrAPIv1ObservationVariableDTO.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
