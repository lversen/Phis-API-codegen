...
class MoveCreationDTO(BaseModel):
    """
    MoveCreationDTO
    """ # noqa: E501
    ...
    is_instant: StrictBool = Field(description="Indicate if the event is instant")
    description: Optional[StrictStr] = None
    targets: List[StrictStr] = Field(description="URI(s) of items concerned by this event")
    ...
    targets_positions: Optional[List[TargetPositionCreationDTO]] = None
    publisher: Optional[UserGetDTO] = None
    publication_date: Optional[datetime] = None
    last_updated_date: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["uri", "rdf_type", "start", "end", "is_instant", "description", "targets", "relations", "from", "to", "targets_positions", "publisher", "publication_date", "last_updated_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "targets_positions": [TargetPositionCreationDTO.from_dict(_item) for _item in obj["targets_positions"]] if obj.get("targets_positions") is not None else None,
