...
class DocumentGetDTO(BaseModel):
    """
    DocumentGetDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["uri", "publisher", "publication_date", "last_updated_date", "identifier", "rdf_type", "rdf_type_name", "title", "date", "description", "targets", "authors", "language", "format", "keywords", "deprecated", "source"]
