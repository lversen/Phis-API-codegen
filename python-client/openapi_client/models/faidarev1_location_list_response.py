...
class Faidarev1LocationListResponse(BaseModel):
    """
    Faidarev1LocationListResponse
    """ # noqa: E501
    metadata: Optional[MetadataDTO] = None
    result: Optional[BrapiDataResponsePartListFaidarev1LocationDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": BrapiDataResponsePartListFaidarev1LocationDTO.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
