...
class GermplasmGetAllDTO(BaseModel):
    """
    GermplasmGetAllDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["uri", "rdf_type", "rdf_type_name", "name", "species", "species_name", "publisher", "publication_date", "last_updated_date"]
