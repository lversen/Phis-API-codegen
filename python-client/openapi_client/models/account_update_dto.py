...
class AccountUpdateDTO(BaseModel):
    ...
    AccountUpdateDTO
    """ # noqa: E501
    uri: StrictStr = Field(description="Account URI")
    ...
    password: Optional[StrictStr] = Field(default=None, description="Account password")
    linked_person: Optional[StrictStr] = Field(default=None, description="URI of the Person linked to this account")
    __properties: ClassVar[List[str]] = ["uri", "email", "admin", "language", "enable", "favorites", "password", "linked_person"]
