...
class FacilityAddressDTO(BaseModel):
    """
    FacilityAddressDTO
    """ # noqa: E501
    ...
    readable_address: Optional[StrictStr] = Field(default=None, alias="readableAddress")
    __properties: ClassVar[List[str]] = ["countryName", "locality", "postalCode", "region", "streetAddress", "readableAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "readableAddress": obj.get("readableAddress")
        })
        return _obj
