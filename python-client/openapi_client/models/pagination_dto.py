...
class PaginationDTO(BaseModel):
    ...
    limit_count: Optional[StrictInt] = Field(default=None, alias="limitCount")
    has_next_page: Optional[StrictBool] = Field(default=None, alias="hasNextPage")
    __properties: ClassVar[List[str]] = ["pageSize", "currentPage", "totalCount", "totalPages", "limitCount", "hasNextPage"]
