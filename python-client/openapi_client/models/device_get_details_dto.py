...
class DeviceGetDetailsDTO(BaseModel):
    """
    DeviceGetDetailsDTO
    """ # noqa: E501
    uri: Optional[StrictStr] = None
    rdf_type: Optional[StrictStr] = Field(default=None, description="rdfType URI")
    rdf_type_name: Optional[StrictStr] = None
    name: StrictStr = Field(description="Device name")
    brand: Optional[StrictStr] = Field(default=None, description="Device brand")
    constructor_model: Optional[StrictStr] = Field(default=None, description="Device model")
    ...
    start_up: Optional[date] = Field(default=None, description="Device date of start-up")
    removal: Optional[date] = Field(default=None, description="Device date of removal")
    ...
    __properties: ClassVar[List[str]] = ["uri", "rdf_type", "rdf_type_name", "name", "brand", "constructor_model", "serial_number", "person_in_charge", "start_up", "removal", "relations", "description", "metadata", "publisher", "publication_date", "last_updated_date"]
