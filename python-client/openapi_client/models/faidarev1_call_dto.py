...
class Faidarev1CallDTO(BaseModel):
    """
    Faidarev1CallDTO
    """ # noqa: E501
    call: Optional[StrictStr] = None
    data_types: Optional[List[StrictStr]] = Field(default=None, alias="dataTypes")
    methods: Optional[List[StrictStr]] = None
    versions: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["call", "dataTypes", "methods", "versions"]
