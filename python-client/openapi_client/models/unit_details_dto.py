...
class UnitDetailsDTO(BaseModel):
    """
    UnitDetailsDTO
    """ # noqa: E501
    ...
    alternative_symbol: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["uri", "name", "description", "symbol", "alternative_symbol", "exact_match", "close_match", "broad_match", "narrow_match", "publisher", "publication_date", "last_updated_date", "from_shared_resource_instance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "alternative_symbol": obj.get("alternative_symbol"),
