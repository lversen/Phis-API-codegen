...
class ScientificObjectDetailDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uri", "publisher", "publication_date", "last_updated_date", "rdf_type", "rdf_type_name", "name", "parent", "parent_name", "factor_level", "relations", "geometry"]
