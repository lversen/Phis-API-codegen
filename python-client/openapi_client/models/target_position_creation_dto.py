...
class TargetPositionCreationDTO(BaseModel):
    """
    TargetPositionCreationDTO
    """ # noqa: E501
    target: StrictStr
    position: Optional[PositionCreationDTO] = None
    __properties: ClassVar[List[str]] = ["target", "position"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "position": PositionCreationDTO.from_dict(obj["position"]) if obj.get("position") is not None else None
        })
        return _obj
