...
class BrapiDataResponsePartListBrAPIv1StudyDTO(BaseModel):
    """
    BrapiDataResponsePartListBrAPIv1StudyDTO
    """ # noqa: E501
    data: Optional[List[BrAPIv1StudyDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BrAPIv1StudyDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
