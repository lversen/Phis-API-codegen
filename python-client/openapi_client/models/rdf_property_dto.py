...
class RDFPropertyDTO(BaseModel):
    """
    RDFPropertyDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["uri", "domain", "range", "parent", "rdf_type", "name_translations", "comment_translations", "publisher", "publication_date", "last_updated_date"]
