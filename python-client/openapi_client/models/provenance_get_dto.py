...
class ProvenanceGetDTO(BaseModel):
    """
    ProvenanceGetDTO
    """ # noqa: E501
    uri: Optional[StrictStr] = Field(default=None, description="provenance name")
    ...
    prov_activity: Optional[List[ActivityGetDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prov_activity": [ActivityGetDTO.from_dict(_item) for _item in obj["prov_activity"]] if obj.get("prov_activity") is not None else None,
