...
class EventDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uri", "rdf_type", "rdf_type_name", "start", "end", "is_instant", "description", "targets", "relations", "publication_date", "last_updated_date", "publisher"]
