...
class CharacteristicDetailsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uri", "name", "description", "publisher", "publication_date", "last_updated_date", "exact_match", "close_match", "broad_match", "narrow_match", "from_shared_resource_instance"]
