...
class FacilityUpdateDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uri", "rdf_type", "name", "organizations", "address", "geometry", "publisher", "publication_date", "last_updated_date", "relations", "rdf_type_name", "sites", "variableGroups"]
