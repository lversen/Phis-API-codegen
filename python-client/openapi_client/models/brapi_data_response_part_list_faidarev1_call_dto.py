...
class BrapiDataResponsePartListFaidarev1CallDTO(BaseModel):
    """
    BrapiDataResponsePartListFaidarev1CallDTO
    """ # noqa: E501
    data: Optional[List[Faidarev1CallDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Faidarev1CallDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
