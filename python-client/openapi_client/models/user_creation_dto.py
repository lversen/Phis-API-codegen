...
class UserCreationDTO(BaseModel):
    ...
    first_name: StrictStr = Field(description="Person first name")
    last_name: StrictStr = Field(description="Person last name")
    email: StrictStr = Field(description="User email")
    language: StrictStr = Field(description="Account language")
    password: StrictStr = Field(description="Account password")
    admin: StrictBool = Field(description="Account admin flag")
    ...
    __properties: ClassVar[List[str]] = ["uri", "first_name", "last_name", "email", "language", "password", "admin", "enable", "favorites", "linked_person"]
