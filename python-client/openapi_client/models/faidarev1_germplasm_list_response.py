...
class Faidarev1GermplasmListResponse(BaseModel):
    """
    Faidarev1GermplasmListResponse
    """ # noqa: E501
    metadata: Optional[MetadataDTO] = None
    result: Optional[BrapiDataResponsePartListFaidarev1GermplasmDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": BrapiDataResponsePartListFaidarev1GermplasmDTO.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
