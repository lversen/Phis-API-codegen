...
class Faidarev1ObservationVariableListResponse(BaseModel):
    """
    Faidarev1ObservationVariableListResponse
    """ # noqa: E501
    metadata: Optional[MetadataDTO] = None
    result: Optional[BrapiDataResponsePartListFaidarev1ObservationVariableDTO] = None
    __properties: ClassVar[List[str]] = ["metadata", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": BrapiDataResponsePartListFaidarev1ObservationVariableDTO.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
