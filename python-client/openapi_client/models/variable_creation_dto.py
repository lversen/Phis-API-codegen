...
class VariableCreationDTO(BaseModel):
    """
    VariableCreationDTO
    """ # noqa: E501
    ...
    entity: StrictStr
    entity_of_interest: Optional[StrictStr] = None
    characteristic: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["uri", "name", "alternative_name", "description", "entity", "entity_of_interest", "characteristic", "trait", "trait_name", "method", "unit", "species", "datatype", "time_interval", "sampling_interval", "exact_match", "close_match", "broad_match", "narrow_match"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entity_of_interest": obj.get("entity_of_interest"),
