...
class AreaGetDTO(BaseModel):
    """
    AreaGetDTO
    """ # noqa: E501
    uri: Optional[StrictStr] = None
    rdf_type: Optional[StrictStr] = None
    is_structural_area: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    publisher: Optional[UserGetDTO] = None
    geometry: Optional[GeoJsonObject] = None
    event: Optional[EventGetDTO] = None
    publication_date: Optional[datetime] = None
    last_updated_date: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["uri", "rdf_type", "is_structural_area", "name", "description", "publisher", "geometry", "event", "publication_date", "last_updated_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event": EventGetDTO.from_dict(obj["event"]) if obj.get("event") is not None else None,
