...
class ScientificObjectNodeDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uri", "name", "geometry", "rdf_type", "rdf_type_name", "publication_date", "last_updated_date", "creation_date", "destruction_date"]
