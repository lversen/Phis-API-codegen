...
class FactorLevelGetDetailDTO(BaseModel):
    """
    ...
    factor_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["uri", "name", "description", "factor", "factor_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "factor_name": obj.get("factor_name")
        })
        return _obj
