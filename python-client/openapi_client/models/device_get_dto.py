...
class DeviceGetDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uri", "rdf_type", "rdf_type_name", "name", "brand", "constructor_model", "serial_number", "person_in_charge", "start_up", "removal", "relations", "description", "publisher", "publication_date", "last_updated_date"]
