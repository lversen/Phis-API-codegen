...
class PropertiesByDomainDTO(BaseModel):
    """
    PropertiesByDomainDTO
    """ # noqa: E501
    domain: Optional[StrictStr] = None
    properties: Optional[List[ResourceTreeDTO]] = None
    __properties: ClassVar[List[str]] = ["domain", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [ResourceTreeDTO.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj
